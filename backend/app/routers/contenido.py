...
from app.models.contenido import ContenidoCreate, ContenidoUpdate, ContenidoResponse, EstadoContenido
from app.dependencies.auth import get_current_user, require_role
from app.models.user import UserRole
from app.services import generate_contenido, get_brand_manual_by_id, format_brand_context
...
async def approve_contenido(
    contenido_id: str,
    current_user: UserResponse = Depends(require_role([UserRole.APROBADOR_A, UserRole.ADMIN]))
):
    supabase = get_supabase()
    response = supabase.table("contenido").update({
